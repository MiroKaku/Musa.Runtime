...
memcpy_name     TEXTEQU <memcpy_ffs>
memmove_name    TEXTEQU <memmove_ffs>
ELSE
memcpy_name     TEXTEQU <memcpy>
memmove_name    TEXTEQU <memmove>
ENDIF
...
; mem routines. See https://devdiv.visualstudio.com/DevDiv/_workitems/edit/1720249
        NESTED_ENTRY memcpy_repmovs, _TEXT$21
        ...
        NESTED_END memcpy_repmovs, _TEXT$21
...
; Note: This is placed in a separate coffgroup along with a few other
; mem routines. See https://devdiv.visualstudio.com/DevDiv/_workitems/edit/1720249
        LEAF_ENTRY_ARG3 memcpy_name, _TEXT$21, dst:ptr byte, src:ptr byte, count:dword

        OPTION PROLOGUE:NONE, EPILOGUE:NONE

        memmove_name = memcpy_name
...
;
        ...
        lea      r9, [rcx + 64]                                  ; check if the destination block is less than 64 bytes from src for High to low copy.
        cmp      rcx, rdx
        cmova    r9, rdx
        cmp      r9, rdx                                         ; dst + 64 (rcx) > src && dst <= src
        ja       MoveWithYMM
