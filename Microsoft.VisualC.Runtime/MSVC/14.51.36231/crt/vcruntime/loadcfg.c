...
extern volatile PVOID __guard_check_icall_fptr;
#if defined(_AMD64_) || defined(_ARM64_)
extern volatile PVOID __guard_dispatch_icall_fptr;
#endif
#if defined(_AMD64_)
...
#endif
extern volatile __check_guard_fp __castguard_check_failure_os_handled_fptr;
...
#if defined(_AMD64_) || defined(_ARM64_)
extern void* (__cdecl* volatile __guard_memcpy_fptr)(void* dst, void* src, size_t count);
#pragma comment(linker, "/alternatename:__guard_memcpy_fptr=__AbsoluteZero")
#endif
