...
#define __RELIABILITY_CONTRACT _CRT_RELIABILITY_CONTRACT
#define SECURITYCRITICAL_ATTRIBUTE _CRT_SECURITYCRITICAL_ATTRIBUTE
#define ASSERT_UNMANAGED_CODE_ATTRIBUTE _CRT_ASSERT_UNMANAGED_CODE_ATTRIBUTE
