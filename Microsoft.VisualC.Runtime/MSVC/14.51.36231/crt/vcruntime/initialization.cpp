...
#define INIT_STRING_FUNCTIONS 1
    ...
    static bool __IsWindowsVersionOrGreaterEx(WORD wMajorVersion, WORD wMinorVersion, WORD wServicePackMajor, WORD wBuildNumber)
    {
    ...
    static bool __IsWindows1122H2OrGreater()
    {
