...
#ifndef _ONECORE
    _CRT_INTEROPSERVICES_DLLIMPORT("KERNEL32.dll", "EncodePointer", _CRT_INTEROP_CALLING_CONVENTION_WINAPI)
#else  // _ONECORE
    _CRT_INTEROPSERVICES_DLLIMPORT("API-MS-WIN-CORE-UTIL-L1-1-0.dll", "EncodePointer", _CRT_INTEROP_CALLING_CONVENTION_WINAPI)
#endif // _ONECORE
...
#ifndef _ONECORE
    _CRT_INTEROPSERVICES_DLLIMPORT("KERNEL32.dll", "DecodePointer", _CRT_INTEROP_CALLING_CONVENTION_WINAPI)
#else  // _ONECORE
    _CRT_INTEROPSERVICES_DLLIMPORT("API-MS-WIN-CORE-UTIL-L1-1-0.dll", "DecodePointer", _CRT_INTEROP_CALLING_CONVENTION_WINAPI)
#endif // _ONECORE
