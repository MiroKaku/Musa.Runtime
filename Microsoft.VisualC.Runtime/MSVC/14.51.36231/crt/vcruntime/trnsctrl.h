...
typedef struct FrameInfo
{
    ...
    #define UNWINDSTATE(base, fixed_offset, dyn_offset)    *((int*)((char*)base + fixed_offset + dyn_offset))
    #define UNWINDTRYBLOCK(base, fixed_offset, dyn_offset) *((int*)((char*)(OffsetToAddress(fixed_offset + dyn_offset, base)) + 4))
    #define UNWINDHELP(base, fixed_offset, dyn_offset)     *((__int64*)((char*)base + fixed_offset + dyn_offset))
...
// implementation shared by the x64 and arm64 EH implementations.
