...
#define _CRT_SUPPRESS_C4950 __pragma(warning(push)) __pragma(warning(disable: 4950))
#define _CRT_RESTORE_C4950  __pragma(warning(pop))


// Attributes for managed declarations in the CRT
#ifdef _M_CEE
    // The following macros are used to simplify compilation in different modes for managed libs. We have
    // these compilation modes for managed libs:
    // 1. /clr, which is the plain vanilla mixed mode targeting .NET Framework. It has just _M_CEE defined. The
    // support libs for this mode are msvcmrt[d].lib.
    // 2. /clr:pure, which is the pure MSIL mode targeting .NET Framework. It has _M_CEE and _M_CEE_PURE defined.
    // The support libs for this mode are msvcurt[d].lib. This mode has been deprecated for many years.
    // 3. /clr:netcore, which is mixed mode targeting .NET Core 9.0 (or later). It has _M_CEE and _CLR_NETCORE defined.
    // The support libs for this mode are msvcmrt[d]_netcore.lib, built against .NET Core 9.0 (or later).
    // 4. /clr:netcore + /clr:pure: which is the pure MSIL mode targeting .NET Core 3.1, meant for supporting WPF
    // until they migrate off /clr:pure. This mode is now an error in the driver and /d1clrpure + /clr:netcore switch
    // will need to be used. The support libs for this mode are msvcurt[d]_netcore.lib, built against .NET Core 3.1,
    // which is officially out of support.
    ...
    #define _CRT_INTEROP_CALLING_CONVENTION_CDECL System::Runtime::InteropServices::CallingConvention::Cdecl
    #define _CRT_INTEROP_CALLING_CONVENTION_WINAPI System::Runtime::InteropServices::CallingConvention::Winapi

    #if !defined(_CLR_NETCORE) || defined(_M_CEE_PURE)
        #define _CRT_RELIABILITY_CONTRACT \
            [System::Runtime::ConstrainedExecution::ReliabilityContract( \
                System::Runtime::ConstrainedExecution::Consistency::WillNotCorruptState, \
                System::Runtime::ConstrainedExecution::Cer::Success)]
        #define _CRT_PREPARE_CONSTRAINED_REGIONS() \
        ...
        #define _CRT_CONSTRAINED_EXECUTION_PRE_PREPARE_METHOD \
        ...
        #define _CRT_SERIALIZABLE_ATTRIBUTE_FOR_CROSS_APPDOMAIN_USE [System::Serializable]
    #else
        // .NET 6 and later has obsoleted
        //      System.Runtime.ConstrainedExecution.ReliabilityContractAttribute
        //      System.Runtime.CompilerServices.RuntimeHelpers.PrepareConstrainedRegions()
        //      System.Security.SecurityCriticalAttribute
        //      System.Security.Permissions.SecurityPermisssionAttribute
        //      System.Security.ContrainedExecution.PrePrepareMethodAttribute
        //      System.SerializableAttribute
        // Suppress the resulting C4950 warnings. The missing functionality is neither supported
        // nor needed in .NET 6 and later (according to the .NET team).
        #define _CRT_RELIABILITY_CONTRACT \
            _CRT_SUPPRESS_C4950 \
            [System::Runtime::ConstrainedExecution::ReliabilityContract( \
                System::Runtime::ConstrainedExecution::Consistency::WillNotCorruptState, \
        ...
        #define _CRT_SECURITYSAFECRITICAL_ATTRIBUTE \
            ...
            _CRT_RESTORE_C4950
        #define _CRT_SERIALIZABLE_ATTRIBUTE_FOR_CROSS_APPDOMAIN_USE \
            _CRT_SUPPRESS_C4950 \
            [System::Serializable] \
            _CRT_RESTORE_C4950
    #endif
#else   // ^^^^ _M_CEE / vvvv !_M_CEE
    #define _CRT_INTEROPSERVICES_DLLIMPORT(_DllName , _EntryPoint , _CallingConvention)
    #define _CRT_SUPPRESS_UNMANAGED_CODE_SECURITY
    #define _CRT_INTEROP_CALLING_CONVENTION_CDECL
    #define _CRT_INTEROP_CALLING_CONVENTION_WINAPI
    #define _CRT_RELIABILITY_CONTRACT
    #define _CRT_ASSERT_UNMANAGED_CODE_ATTRIBUTE
    #define _CRT_SECURITYCRITICAL_ATTRIBUTE
    #define _CRT_SECURITYSAFECRITICAL_ATTRIBUTE
...
extern "C++" {
        ...
        C const comparand) noexcept
    {
        ...
        inline __int32 __crt_interlocked_read_32(__int32 const volatile* target) noexcept
        {
            ...
            __int32 const result = __load_acquire32(reinterpret_cast<const volatile unsigned __int32*>(target));
            return result;
            ...
            {
                #if defined _M_ARM64 || defined _M_ARM64EC
                __int64 const result = __load_acquire64(reinterpret_cast<const volatile unsigned __int64*>(target));
                return result;
                #elif defined _M_X64
