...
; mem routines. See https://devdiv.visualstudio.com/DevDiv/_workitems/edit/1720249
        AREA    |.text$mn$21|,ALIGN=5,CODE,READONLY,CODEALIGN

#if !defined(_CRT_APP) && !defined(_CRT_ONECORE) && !defined(_CRT_ENCLAVE)
        IMPORT  CHPENAME(__arm64_safe_unaligned_memory_access)
        IMPORT  A64NAME(memset_unaligned_zva_large)
#endif
...
; processes 32 bytes of instruction (8 instructions on ARM64) at time. Each
...
; Note: This is placed in a separate coffgroup along with a few other
; mem routines. See https://devdiv.visualstudio.com/DevDiv/_workitems/edit/1720249
        LEAF_ENTRY A64NAME(memset), |.text$$mn$$21|, 5

#if !defined(_CRT_APP) && !defined(_CRT_ONECORE) && !defined(_CRT_ENCLAVE)
        adrp    x8, CHPENAME(__arm64_safe_unaligned_memory_access)
        ldr     w8, [x8, CHPENAME(__arm64_safe_unaligned_memory_access)]
        cbz     w8, memset_AlwaysAligned
        b       A64NAME(memset_unaligned_zva_large)

memset_AlwaysAligned
#endif
