...
; mem routines. See https://devdiv.visualstudio.com/DevDiv/_workitems/edit/1720249
        ...
        IMPORT  A64NAME(memcpy_unaligned)
#endif
...
; mem routines. See https://devdiv.visualstudio.com/DevDiv/_workitems/edit/1720249
        ...
        cbz     w8, memcpy_AlwaysAligned
        b       A64NAME(memcpy_unaligned)

memcpy_AlwaysAligned
#endif
...
; Note: This is placed in a separate coffgroup along with a few other
; mem routines. See https://devdiv.visualstudio.com/DevDiv/_workitems/edit/1720249
        LEAF_ENTRY __memcpy_forward_large_neon, |.text$$mn$$21|, 5
...
; Note: This is placed in a separate coffgroup along with a few other
; mem routines. See https://devdiv.visualstudio.com/DevDiv/_workitems/edit/1720249
        LEAF_ENTRY __memcpy_reverse, |.text$$mn$$21|, 5
...
; Note: This is placed in a separate coffgroup along with a few other
; mem routines. See https://devdiv.visualstudio.com/DevDiv/_workitems/edit/1720249
        LEAF_ENTRY __memcpy_reverse_large_neon, |.text$$mn$$21|, 5
