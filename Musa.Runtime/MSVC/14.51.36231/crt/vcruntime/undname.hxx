...
#define CC_preserve_none ((unsigned char)0x02)
...
#define PDT_extend_extend       '_'
#define PDT_ex_module_owner     'A'
#define PDT_ex_module_owner_not_exported 'B'
#define PDT_ex_sve              'C'
...
#define BDT_svbool          'A'
#define BDT_svint8          'B'
#define BDT_svint16         'C'
#define BDT_svint32         'D'
#define BDT_svint64         'E'
#define BDT_svuint8         'F'
#define BDT_svuint16        'G'
#define BDT_svuint32        'H'
#define BDT_svuint64        'I'
#define BDT_svbfloat16      'J'
#define BDT_svfloat16       'K'
#define BDT_svfloat32       'L'
#define BDT_svfloat64       'M'
