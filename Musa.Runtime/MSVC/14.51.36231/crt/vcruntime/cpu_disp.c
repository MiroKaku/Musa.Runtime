...
PVOID WINAPI _Musa_LocateXStateFeature(
    _In_ PCONTEXT Context,
    _In_ DWORD FeatureId,
    _Out_opt_ PDWORD Length
);

LocateXStateFeatureFn __locateXStateFeature = nullptr;
DWORD64 __arm64_xstate_features = 0;
int __cdecl __isa_available_init()
{
    __arm64_xstate_features = GetEnabledXStateFeatures();
    __locateXStateFeature = _Musa_LocateXStateFeature;
    return 0;
}
